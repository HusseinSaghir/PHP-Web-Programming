...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'hsaghir';//this will be your WCC username
      $dbUsr = 'hsaghir';//this will be your WCC username
      $dbPass = 'pLkbaugkoXq7a1K';//this will be the password found in the video.
